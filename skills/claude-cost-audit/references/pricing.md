...
- **Opus 5 fast mode is a different rate for the same model ID:** $10.00 / $50.00 per MTok, 2× standard. `usage.speed == "fast"` marks those turns — price them separately or the session under-counts by half on every fast turn.
